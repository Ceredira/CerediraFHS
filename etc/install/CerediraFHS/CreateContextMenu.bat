...
call :CreateApp "%root%" "CerediraFHS" "CerediraFHS" "\"%SystemRoot%\explorer.exe\" /e,\"%ceredira_path%\"" "%SystemRoot%\explorer.exe"
call :CreateApp "%root%" "home" "home" "\"%SystemRoot%\explorer.exe\" /e,\"%ceredira_path%\home\"" "%SystemRoot%\explorer.exe"
call :CreateApp "%root%" "man" "man" "\"%SystemRoot%\explorer.exe\" /e,\"%ceredira_path%\man\"" "%SystemRoot%\explorer.exe"
call :CreateApp "%root%" "tmp" "tmp" "\"%SystemRoot%\explorer.exe\" /e,\"%ceredira_path%\tmp\"" "%SystemRoot%\explorer.exe"
...
rem Эта функция не оборачивает appPath в дополнительные кавычки.
:CreateApp
